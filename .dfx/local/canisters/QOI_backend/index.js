...
import { idlFactory } from './QOI_backend.did.js';
export { idlFactory } from './QOI_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.QOI_BACKEND_CANISTER_ID;
 ...
 */
export const QOI_backend = createActor(canisterId);
