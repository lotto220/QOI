...
/***/ "./src/declarations/QOI_backend/QOI_backend.did.js":
/*!*********************************************************!*\
  !*** ./src/declarations/QOI_backend/QOI_backend.did.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/QOI_backend/index.js":
/*!***********************************************!*\
  !*** ./src/declarations/QOI_backend/index.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "QOI_backend": () => (/* binding */ QOI_backend),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "idlFactory": () => (/* reexport safe */ _QOI_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _QOI_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./QOI_backend.did.js */ "./src/declarations/QOI_backend/QOI_backend.did.js");
/* provided dependency */ var process = __webpack_require__(/*! ./node_modules/process/browser.js */ "./node_modules/process/browser.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./QOI_backend.did.js")._SERVICE>}
 */
...
See https://internetcomputer.org/docs/current/developer-docs/updates/release-notes/ for migration instructions`);
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_QOI_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the QOI_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./QOI_backend.did.js")._SERVICE>}
 */
const QOI_backend = createActor(canisterId);
...
"use strict";
/*!***************************************!*\
  !*** ./src/QOI_frontend/src/index.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_QOI_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/QOI_backend */ "./src/declarations/QOI_backend/index.js");
...
document.querySelector("form").addEventListener("submit", async (e) => {
  ...
  fileInput.onchange = e => {
    ...
    reader.onload = readerEvent => {
        ...
        _declarations_QOI_backend__WEBPACK_IMPORTED_MODULE_0__.QOI_backend.encodeBitmap({desc: {width: view.length / 2 / 3, height: 2, channels: 3, colorspace: 1}, data: view}).then((encodeResult) => {
          console.log("Encoding results:");
          console.log(encodeResult);
          console.log("\n");
          _declarations_QOI_backend__WEBPACK_IMPORTED_MODULE_0__.QOI_backend.decodeQOI(encodeResult.ok).then((decodeResult) => {
            console.log("Decoding results:");
            console.log(decodeResult);
          });

          _declarations_QOI_backend__WEBPACK_IMPORTED_MODULE_0__.QOI_backend.getPerceptualHash(encodeResult.ok).then(perceptualHash => {
