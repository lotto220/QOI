...
import { idlFactory } from './QOI_frontend.did.js';
export { idlFactory } from './QOI_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.QOI_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./QOI_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the QOI_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./QOI_frontend.did.js")._SERVICE>}
 */
export const QOI_frontend = createActor(canisterId);
